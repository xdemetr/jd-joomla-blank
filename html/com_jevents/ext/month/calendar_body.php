...
<table class="cal_table" align="center" cellpadding="0" cellspacing="0" width="100%">
	<tr>
      	...
      	<?php echo "</a>"; }?>
            ...
            <tr valign="top">
                <?php foreach ($this->data["daynames"] as $dayname) { ?>
                	<td class="cal_td_daysnames" align="center" height="18" valign="middle" width="14%">
                        <?php 
                        echo $dayname;?>
					</td>
                    <?php
			...
			<tr valign="top" style="height:80px;">				
                ...
                for ($d=0;$d<7 && $dn<$datacount;$d++){
                	...
                	switch ($currentDay["monthType"]){
                		...
                		case "following":
                		?>
                    <td class="cal_td_daysoutofmonth" align="center" height="50" valign="middle">
                    ...
                    <td class="<?php echo $style;?>" width="14%" align="center" height="50" valign="top">
                        <div class="cell">
                    	 <a href="<?php echo $currentDay["link"]; ?>" title="<?php echo JText::_('JEV_CLICK_TOSWITCH_DAY'); ?>"><?php echo $currentDay['d']; ?></a>

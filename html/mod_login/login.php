...
<div class="reg-form-block-sidebar">
...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" >
	...
	<p id="form-login-username" class="line-icon icon-user">
	...
	<p id="form-login-password" class="line-icon icon-password">
	...
	<?php
		...
		if ($usersConfig->get('allowUserRegistration')) : ?>
			<a class="btn btn-registration" href="<?php echo JRoute::_('index.php?option=com_users&view=registration'); ?>">
